...
if __name__ == '__main__':
    ...
    book.add_metadata('DC', 'identifier', f'url:https://www.scribblehub.com/series/534819/meow-mixup/', {'id': 'Source'})
    book.add_metadata('DC','subject','razzle, dazzle, foo, bar', {'id': 'tags'})
    book.add_metadata('DC','subject','action, adventure, smut', {'id': 'genre'})
